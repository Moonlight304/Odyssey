...
<head>
  ...
  <title>Heritage and History</title>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="assets\images\Delhi.avif" alt="">
                    <h4>Delhi</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets\images\Rjasthan.avif" alt="">
                    <h4>Rajasthan</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets\images\Agra.avif" alt="">
                    <h4>Agra</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets\images\Karanaatka.jpg" alt="">
                    <h4>Karnataka</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets\images\Madhya Pradesh.avif" alt="">
                    <h4>Madhya Pradesh</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets\images\Tamilnadu.webp" alt="">
                    <h4>Tamilnadu</h4>
                  </div>
                </div>
          ...
          <div class="owl-weekly-offers owl-carousel">
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets\images\Rjasthan.avif" alt="">
                <div class="text">
                  <h4>Rajasthan<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets\images\Agra.avif" alt="">
                <div class="text">
                  <h4>Agra<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets\images\Karanaatka.jpg" alt="">
                <div class="text">
                  <h4>Karnataka<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets\images\Madhya Pradesh.avif" alt="">
                <div class="text">
                  <h4>Madhya Pradesh<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>5999rs<br><span>/person</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets\images\Tamilnadu.webp" alt="">
                <div class="text">
                  <h4>Tamil Nadu<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>5999rs<br><span>/person</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
